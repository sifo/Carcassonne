...
public class NextTilePanel extends JPanel {
	...
	public NextTilePanel() {
		width = 80;
		height = 80;
		bufferedImage = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
	}

	public NextTilePanel(int width, int height) {
		this.width = width;
		this.height = height;
		bufferedImage = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
	}

	public NextTilePanel(String filePath) {
	...
	public void setImage(String file) {
	 ...
	 public NextTilePanel getClone(){
		 return new NextTilePanel(fileString);
	 }
}
