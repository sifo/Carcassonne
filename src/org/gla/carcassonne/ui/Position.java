...
public enum Position {
	verticalTopLeft, horizontalTopLeft, centerLeft, 
	verticalBottomLeft, horizontalBottomLeft, topMiddle, 
	centerMiddle, bottomMiddle, verticalTopRight, horizontalTopRight, 
	centerRight, horizontalBottomRight, verticalBottomRight;
	...
	public static Position getPositionAfterRotation(Position position,
			int rotation) {
		switch (position) {
		case verticalTopLeft: {
			if (rotation == 0)
