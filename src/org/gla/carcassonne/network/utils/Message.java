...
public class Message {
    ...
    static MessageList makeList(String type, String[] s) {
        MessageUnit[] ll = new MessageUnit[s.length + 1];
    ...
    static MessageList makeList(String type, MessageUnit[] l) {
        MessageUnit[] ll = new MessageUnit[l.length + 1];
        ll[0] = new MessageType(type);
    ...
    public Message(String type) {
        this(makeList(type, new MessageUnit[0]));
    }
    ...
    public Message(String type, MessageUnit... l) {
